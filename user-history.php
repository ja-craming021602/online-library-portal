...
<div class="main-content">
    ...
    <div class="user-area">
        ...
        <div class="card">
            ...
            <div class="user-info">
                <b>Last Name </b> <p class="inner-bubble"><?php echo htmlspecialchars($user_name['LastName']); ?></p>
                <b>First Name</b> <p class="inner-bubble"><?php echo htmlspecialchars($user_name['FirstName']); ?></p>
                <b>User ID   </b> <p class="inner-bubble"><?php echo htmlspecialchars($user_id); ?></p>
            </div>
        </div>
    ...
    <?php if (isset($_GET['search-user'])): ?>
        ...
        <div class="borrow-area card">
            ...
            <div class="center"><h3><?php echo htmlspecialchars(count($borrow_array)).' Result'; if (count($borrow_array) > 1) echo 's'; ?></h3></div>
